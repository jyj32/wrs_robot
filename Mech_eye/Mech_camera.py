...
class CaptureImage(object):
    # 初始化
    def __init__(self, save_directory = 'yanpu_ur6/images/Mech'):
        self.camera = Camera()
    ...
    def capture_and_generate_pointcloud(self, save = True, show=False,
                                         pcb_out_path=r"E:\py_project\wrsrobot\wrs_shu\yanpu_ur5\images\Mech\pointcloud.ply",
...
if __name__ == '__main__':
    ...
    Mech_camera = CaptureImage(save_directory = r'images')
