...
class GOFA5(ri.RobotInterface):  #定义机器人类：gofa5，继承自ri.RobotInterface类
    ...
    def fk(self, component_name='arm', jnt_values=np.zeros(6)):     #定义fk正运动学方法
        """
    ...
    def jaw_to(self, hnd_name='hnd_s', jawwidth=0.0):#夹爪控制
        self.hnd.jaw_to(jawwidth)

    def hold(self, hnd_name, objcm, jawwidth=None):#夹爪夹紧
        """
    ...
    def release(self, hnd_name, objcm, jawwidth=None):#夹爪松开
        """
        the objcm is added as a part of the robot_s to the cd checker
        :param jawwidth:
        :param objcm:
    ...
    def gen_stickmodel(self,
                       ...
                       name='xarm7_shuidi_mobile_stickmodel'):#线框模型
    ...
    def gen_meshmodel(self,
                      ...
                      is_machine=None,
                      is_robot=True,
                      name='xarm_shuidi_mobile_meshmodel'):#网格模型
